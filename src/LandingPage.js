...
export default function LandingPagecomp(props) {
    ...
    const fetchResultFromApi = async () => {
        ...
        const url = 'https://contextualwebsearch-websearch-v1.p.rapidapi.com/api/search/NewsSearchAPI?q=pakistan%20&pageNumber=1&pageSize=10&autoCorrect=true&fromPublishedDate=null&toPublishedDate=null';
